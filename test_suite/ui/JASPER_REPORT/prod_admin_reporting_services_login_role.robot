...
*** Variables ***
${domain}       ${ADMINPROD_URL}

*** Test Cases ***
1. Verify User role = ADM can access Reporting Services successfully
  Login Platform    ${domain}   ${REPORTING_SERVICES}    ${USER_ADM}
