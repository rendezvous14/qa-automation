*** Settings ***
Documentation     PLAT-502 Verify the reporting services integrated with platform successfully
...
1. Verify User role = ADM can access Reporting Services successfully
  Login Platform    ${PARTNERDEV_URL}   ${REPORTING_SERVICES}    ${USER_ADM}
