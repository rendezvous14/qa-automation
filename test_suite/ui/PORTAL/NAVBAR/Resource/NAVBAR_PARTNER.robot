...
${Dashboard_Delivery and Outbound}     id=delivery-and-outbound-0-1
...
# ${Sherlock_HR}    id=hr-1-6
# ${Sherlock_Business Development}    id=business-development-1-7
...
# ${ItemsAndInventory_ImportHistory}    id=import-history-3-3
# ${PurchaseOrders}    id=purchase-orders-4
...
# ${PurchaseOrders_ImportHistory}    id=import-history-4-3
...
${Delivery_ShippingOrder}    id=shipping-orders-5-0
${Delivery_OverPickupOrder}    id=over-pickup-orders-5-1
${Delivery_ManagePickup}    id=manage-pickup-5-2
${Delivery_ManageDelivery}    id=manage-delivery-5-3
${Delivery_ManageReturn}    id=manage-return-5-4
${Delivery_ManageProvider}    id=manage-providers-5-5
${Delivery_ManagePreDefinedPackage}    id=manage-pre-defined-package-5-6
${Delivery_ImportHistory}    id=import-history-5-7
# ${ManageInventoryItems}    id=manage-inventory-items-7
# ${ManageInventoryItems_ListofItems}    id=list-of-items-7-0
# ${ManageSalesOrders}    id=manage-sales-orders-8
# ${ManageSalesOrders_ListofSalesOrders}    id=list-of-sales-orders-8-0
# ${ManageSalesOrders_ListofBackorders}    id=list-of-backorders-8-1
# ${ManageSalesOrders_PickingandQC}    id=picking--qc-8-2
# ${ManageSalesOrders_Packing}    id=packing-8-3
# ${ManageSalesOrders_PrintFulfillmentDoc}    id=print-fulfillment-doc.-8-4
# ${ManageFulfillments}    id=manage-fulfillments-9
# ${ManageFulfillments_ListofFulfillments}    id=list-of-fulfillments-9-0
# ${Import/Export}    id=import/export-10
# ${Import/Export_ImportFailed}    id=import-failed-10-0
# ${Import/Export_TransactionImportHistory}    id=transaction-import-history-10-1
# ${Report}         id=report-11
# ${Report_PendingFulfillmentReport}    id=pending-fulfillment-report-11-0
# ${ManagePartners}    id=manage-partners-12
# ${ManagePartners_ListofPartners}    id=list-of-partners-12-0
# ${SystemConfigurations}    id=system-configuration-13
# ${SystemConfigurations_SetupPaymentTypes}    id=setup-payment-types-13-0
# ${SystemConfigurations_SetupShippingTypes}    id=setup-shipping-types-13-1
# ${SystemConfigurations_SetupNetsuiteLibrary}    id=setup-netsuite-library-13-2
# ${NetsuiteRe-Synchronization}    id=netsuite-re-synchronization-13-3
# #locator
...
# ${Sherlock_HR_locator}    css=#hr-1-6 > span
# ${Sherlock_Business_Development_locator}    css=#business-development-1-7 >    span
...
# ${ItemsAndInventory_ImportHistory_locator}    css=#import-history-3-3 > span
...
${Delivery_locator}    xpath=//*[@id="delivery-5"]/a/span[2]
${Delivery_ShippingOrder_locator}    xpath=//*[@id="shipping-orders-5-0"]/span
${Delivery_OverPickupOrder_locator}   css=#over-pickup-orders-5-1 > span
${Delivery_ManagePickup_locator}    css=#manage-pickup-5-2 > span
${Delivery_ManageDelivery_locator}    css=#manage-delivery-5-3 > span
${Delivery_ManageReturn_locator}    css=#manage-return-5-4 > span
${Delivery_ManageProvider_locator}    css=#manage-providers-5-5 > span
${Delivery_ManagePreDefinedPackage_locator}    css=#manage-pre-defined-package-5-6 > span
${Delivery_ImportHistory_locator}    css=#import-history-5-7 > span
# ${ManageInventoryItems_locator}    css=#manage-inventory-items-7 > a > span
# ${ManageInventoryItems_ListofItems_locator}    css=#list-of-items-7-0 > span
# ${ManageSalesOrders_locator}    css=#manage-sales-orders-8 > a > span
# ${ManageSalesOrders_ListofSalesOrders_locator}    css=#list-of-sales-orders-8-0 > span
# ${ManageSalesOrders_ListofBackorders_locator}    css=#list-of-backorders-8-1 > span
# ${ManageSalesOrders_PickingandQC_locator}    css=#picking--qc-8-2 > span
# ${ManageSalesOrders_Packing_locator}    css=#packing-8-3 > span
# ${ManageSalesOrders_PrintFulfillmentDoc_locator}    xpath=//*[@id="print-fulfillment-doc.-8-4"]/span
# ${ManageFulfillments_locator}    css=#manage-fulfillments-9 > a > span
# ${ManageFulfillments_ListofFulfillments_locator}    css=#list-of-fulfillments-9-0 > span
# ${Import/Export_locator}    css=#import\\2f export-10 > a > span
# ${Import/Export_ImportFailed_locator}    css=#import-failed-10-0 > span
# ${Import/Export_TransactionImportHistory_locator}    css=#transaction-import-history-10-1 > span
# ${Report_locator}    css=#report-11 > a > span
# ${Report_PendingFulfillmentReport_locator}    css=#pending-fulfillment-report-11-0 > span
# ${ManagePartners_locator}    css=#manage-partners-12 > a > span
# ${ManagePartners_ListofPartners_locator}    css=#list-of-partners-12-0 > span
# ${SystemConfigurations_locator}    css=#system-configuration-13 > a > span
# ${SystemConfigurations_SetupPaymentTypes_locator}    css=#setup-payment-types-13-0 > span
# ${SystemConfigurations_SetupShippingTypes_locator}    css=#setup-shipping-types-13-1 > span
# ${SystemConfigurations_SetupNetsuiteLibrary_locator}    css=#setup-netsuite-library-13-2 > span
# ${NetsuiteRe-Synchronization_locator}    css=#netsuite-re-synchronization-13-3 > span
...
Validate Sherlock menu
    ...
    ...    AND    Wait Until Page Contains    Public    10
    Run Keyword If    '${isMarketing}'=='true'    Run Keywords    Element Text Should Be    ${Sherlock_Marketing}    Marketing
    ...    AND    Click Element    ${Sherlock_Marketing}
    ...    AND    URL should be    /sherlock/marketing/
    ...    AND    Wait Until Page Contains    Marketing    10
    ...
    ...    AND    Wait Until Page Contains    Finance    10
    ...
    ...    AND    Wait Until Page Contains    Operations    10
    ...
    ...    AND    Wait Until Page Contains    Order Summary    10
    ...
    ...    AND    Wait Until Page Contains    Aging Report    10
    Run Keyword If    '${isHR}'=='true'    Run Keywords    Element Text Should Be    ${Sherlock_HR_locator}    HR
    ...    AND    Click Element    ${Sherlock_HR_locator}
    ...    AND    URL should be    https://acommerce.bamboohr.co.uk/login.php?r=%2Fdashboard%2F
    ...    AND    Wait Until Page Contains    BambooHR    10
    ...
    ...    AND    Wait Until Page Contains    Businessdevelopment    10
...
Validate Items & Inventory menu
    [Arguments]    ${isManage Item}    ${isDemand Forecast}    ${isReplenishment}    ${isImport History}
    Click side bar
    Element Text Should Be    ${ItemsAndInventory_locator}    Item & Inventory
    Click Element    ${ItemsAndInventory_locator}
    Run Keyword If    '${ItemsAndInventory_ManageItem}'=='true'    Run Keywords    Element Text Should Be    ${ItemsAndInventory_ManageItem}    Manage Item
    ...    AND    Click Element    ${ItemsAndInventory_ManageItem}
    ...    AND    Location Should Contain    /beehive/frontend/ui-item/
    ...
    Run Keyword If    '${ItemsAndInventory_ImportHistory}'=='true'    Run Keywords    Element Text Should Be    ${ItemsAndInventory_ImportHistory}    Import History
    ...    AND    Click Element    ${ItemsAndInventory_ImportHistory}
    ...    AND    Location Should Contain    /beehive/frontend/item-master/import-histories/
...
Validate Purchase Orders menu
    ...
    Comment    Run Keyword If    '${isManage Goods Receipt Notes}'=='true'    Run Keywords    Element Text Should Be    ${PurchaseOrders_ManageGoodsReceiptNotes_locator}    Manage Goods Received Notes
...
Validate Delivery menu
    [Arguments]    ${isShipping Order}    ${isOver-Pickup Orders}    ${isManage Pick up}    ${isManage Delivery}    ${isManage Return}    ${isManage Provider}    ${isManage Pre-defined Package}   ${isImport History}
    # Click side bar
...
Validate Manage Inventory Items
