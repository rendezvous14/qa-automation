...
${Sherlock_Public}    id=overview-1-0
...
${ManagePurchaseOrders}    id=manage-purchase-orders-8
${ManagePurchaseOrders_ListOfPurchaseOrders}    id=list-of-purchase-orders-8-0
${ManageItemReceipts}    id=manage-item-receipt-9
${ManageItemReceipts_BatchProcessItemReceipts}    id=batch-process-item-receipts-9-0
${ManageSalesOrders}    id=manage-sales-orders-10
${ManageSalesOrders_ListofSalesOrders}    id=list-of-sales-orders-10-0
${ManageSalesOrders_ListofBackorders}    id=list-of-backorders-10-1
${ManageSalesOrders_PickingandQC}    id=picking--qc-10-2
${ManageSalesOrders_Packing}    id=packing-10-3
${ManageSalesOrders_PrintFulfillmentDoc}    id=print-fulfillment-doc.-10-4
${ManageFulfillments}    id=manage-fulfillments-11
${ManageFulfillments_ListofFulfillments}    id=list-of-fulfillments-11-0
${Import/Export}    id=import/export-12
${Import/Export_ImportFailed}    id=import-failed-12-0
${Import/Export_TransactionImportHistory}    id=transaction-import-history-12-1
${Report}         id=report-13
${Report_PendingFulfillmentReport}    id=pending-fulfillment-report-13-0
${ManagePartners}    id=manage-partners-14
${ManagePartners_ListofPartners}    id=list-of-partners-14-0
${SystemConfigurations}    id=system-configuration-15
${SystemConfigurations_SetupPaymentTypes}    id=setup-payment-types-15-0
${SystemConfigurations_SetupShippingTypes}    id=setup-shipping-types-15-1
${SystemConfigurations_SetupNetsuiteLibrary}    id=setup-netsuite-library-15-2
${NetsuiteRe-Synchronization}    id=netsuite-re-synchronization-15-3
#locator
...
${Sherlock_Public_locator}    css=#overview-1-0 > span
...
${PurchaseOrders_locator}    xpath=//*[@id="[beta]purchase-orders-4"]/a/span
${PurchaseOrders_ManagePurchaseOrders_locator}    xpath=//*[@id="manage-purchase-orders-4-0"]/span
${PurchaseOrders_ManageGoodsReceiptNotes_locator}    xpath=//*[@id="manage-goods-received-notes-4-1"]/span
# ${PurchaseOrders_BatchItemReceipts_locator}    css=#batch-item-receipts-4-2 > span
${PurchaseOrders_ImportHistory_locator}    xpath=//*[@id="import-history-4-2"]/span
...
${ManagePurchaseOrders_locator}    css=#manage-purchase-orders-8 > a > span
${ManagePurchaseOrders_ListOfPurchaseOrders_locator}    css=#list-of-purchase-orders-8-0 > span
${ManageItemReceipts_locator}    css=#manage-item-receipt-9 > a > span
${ManageItemReceipts_BatchProcessItemReceipts}    css=#batch-process-item-receipts-9-0 > span
${ManageSalesOrders_locator}    css=#manage-sales-orders-10 > a > span
${ManageSalesOrders_ListofSalesOrders_locator}    css=#list-of-sales-orders-10-0 > span
${ManageSalesOrders_ListofBackorders_locator}    css=#list-of-backorders-10-1 > span
${ManageSalesOrders_PickingandQC_locator}    css=#picking--qc-10-2 > span
${ManageSalesOrders_Packing_locator}    css=#packing-10-3 > span
${ManageSalesOrders_PrintFulfillmentDoc_locator}    xpath=//*[@id="print-fulfillment-doc.-10-4"]/span
${ManageFulfillments_locator}    css=#manage-fulfillments-11 > a > span
${ManageFulfillments_ListofFulfillments_locator}    css=#list-of-fulfillments-11-0 > span
${Import/Export_locator}    css=#import\\2f export-12 > a > span
${Import/Export_ImportFailed_locator}    css=#import-failed-12-0 > span
${Import/Export_TransactionImportHistory_locator}    css=#transaction-import-history-12-1 > span
${Report_locator}    css=#report-13 > a > span
${Report_PendingFulfillmentReport_locator}    css=#pending-fulfillment-report-13-0 > span
${ManagePartners_locator}    css=#manage-partners-14 > a > span
${ManagePartners_ListofPartners_locator}    css=#list-of-partners-14-0 > span
${SystemConfigurations_locator}    css=#system-configuration-15 > a > span
${SystemConfigurations_SetupPaymentTypes_locator}    css=#setup-payment-types-15-0 > span
${SystemConfigurations_SetupShippingTypes_locator}    css=#setup-shipping-types-15-1 > span
${SystemConfigurations_SetupNetsuiteLibrary_locator}    css=#setup-netsuite-library-15-2 > span
${NetsuiteRe-Synchronization_locator}    css=#netsuite-re-synchronization-15-3 > span
...
Validate Sherlock menu
    ...
    Run Keyword If    '${isPublic}'=='true'    Run Keywords    Element Text Should Be    ${Sherlock_Public_locator}    Overview
    ...    AND    Click Element    ${Sherlock_Public_locator}
    ...    AND    URL should be    /sherlock/public
...
Validate Product Catalog menu
    ...
    ...    AND    Wait Until Page Contains    Product List    40
    ...
    ...    AND    Wait Until Page Contains    Import History    40
    ...
    ...    AND    Wait Until Page Contains    Export History    40
...
Validate Purchase Orders menu
    ...
    Click side bar
    Element Text Should Be    ${PurchaseOrders_locator}    [BETA]Purchase Orders
    ...
    ...    AND    Wait Until Page Contains    Goods Received Note List    10    # Run Keyword If    '${isBatch Item Receipts'=='true'
    ...    # Run Keywords    Element Text Should Be    ${PurchaseOrders_BatchItemReceipts_locator}    Batch Item Receipts    # ...    # AND
    ...    # Click Element    ${PurchaseOrders_BatchItemReceipts_locator}    # ...    # AND    URL should contain    /itemreceipt/import/
...
Validate Delivery menu
    ...
    ...    AND    Wait Until Page Contains    Shipping Orders    20
    ...
    ...    AND    Wait Until Page Contains    Over-Pickup Orders    20
    ...
    ...    AND    Wait Until Page Contains    Manage Pickup    20
    ...
    ...    AND    Wait Until Page Contains    Manage Delivery    20
    ...
    ...    AND    Wait Until Page Contains    Manage Return    20
    ...
    ...    AND    Wait Until Page Contains    Manage Providers    20
    ...
    ...    AND    Wait Until Page Contains    Manage Pre-defined Package    20
